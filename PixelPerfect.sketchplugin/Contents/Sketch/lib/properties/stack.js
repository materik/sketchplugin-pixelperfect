...
Alignment.top = function() {
    return Alignment.new('top');
};
Alignment.middle = function() {
    return Alignment.new('middle');
};
Alignment.bottom = function() {
    return Alignment.new('bottom');
};
Alignment.left = function() {
    return Alignment.new('left');
};
Alignment.center = function() {
    return Alignment.new('center');
};
Alignment.right = function() {
    return Alignment.new('right');
};
