...
describe('components', function() {
    it('new - empty', function() {
        var components = src.Components.init()
    ...
    it('sub - no sublayers', function() {
        ...
        var components = src.Components.sub(layer)
        assert.equal(components.count(), 0)
        assert.deepEqual(components.items(), [])
    })
    ...
    it('items', function() {
        ...
        var components = src.Components.items([component])
    ...
    it('frame', function() {
        ...
        var components = src.Components.init(NSArray.new([layer]))
    ...
    it('count', function() {
        ...
        var components = src.Components.sub(group)
    ...
    it('filter', function() {
        ...
        var components = src.Components.init(NSArray.new([layer1, layer2, layer3]))
    ...
    it('apply', function() {
        ...
        group.insertLayer_afterLayerOrAtEnd(layer2);
        group.insertLayer_afterLayerOrAtEnd(layer3);
        src.Components.apply(NSArray.new([layer1, layer2, layer3]), src.Component.init(group));
