...
describe('components', function() {
    it('new - empty', function() {
        var components = index.Components.init()
    ...
    it('sub - no sublayers', function() {
        ...
        var components = index.Components.sub(layer)
        assert.equal(components.count(), 0)
        assert.deepEqual(components.items(), [])
    })
    ...
    it('items', function() {
        ...
        var components = index.Components.items([component])
    ...
    it('frame', function() {
        ...
        var components = index.Components.init(NSArray.new([layer]))
    ...
    it('count', function() {
        ...
        var components = index.Components.sub(group)
    ...
    it('filter', function() {
        ...
        var components = index.Components.init(NSArray.new([layer1, layer2, layer3]))
    ...
    it('apply', function() {
        ...
        group.insertLayer_afterLayerOrAtEnd(layer2);
        group.insertLayer_afterLayerOrAtEnd(layer3);
        index.Components.apply(NSArray.new([layer1, layer2, layer3]), index.Component.init(group));
