...
describe('components', function() {
    ...
    it('frame', function() {
        ...
        var components = Components.init(NSArray.new([layer]))
    ...
    it('filter', function() {
        ...
        var components = Components.init(NSArray.new([layer1, layer2, layer3]))
    ...
    it('apply', function() {
        ...
        group.insertLayer_afterLayerOrAtEnd(layer2);
        group.insertLayer_afterLayerOrAtEnd(layer3);
        Components.apply(NSArray.new([layer1, layer2, layer3]), Component.init(group));
