...
describe('property', function() {
    describe('size', function() {
            it('width', function() {
                var property = src.Property.parse(src.Component.init(createLayer('w100')));
            ...
            it('width-addition', function() {
                var property = src.Property.parse(src.Component.init(createLayer('w+200')));
                assert.equal(property.isValid(), true);
            ...
            it('width-subtraction', function() {
                var property = src.Property.parse(src.Component.init(createLayer('w-300')));
                assert.equal(property.isValid(), true);
                assert.equal(property.key(), 'width-addition');
            ...
            it('width-percentage', function() {
                var property = src.Property.parse(src.Component.init(createLayer('w50%')));
                assert.equal(property.isValid(), true);
            ...
            it('height', function() {
                var property = src.Property.parse(src.Component.init(createLayer('h100')));
                assert.equal(property.isValid(), true);
            ...
            it('height-addition', function() {
                var property = src.Property.parse(src.Component.init(createLayer('h+200')));
                assert.equal(property.isValid(), true);
            ...
            it('height-subtraction', function() {
                var property = src.Property.parse(src.Component.init(createLayer('h-300')));
                assert.equal(property.isValid(), true);
                assert.equal(property.key(), 'height-addition');
                assert.equal(property.value(), -300);
            });
            ...
            it('height-percentage', function() {
                var property = src.Property.parse(src.Component.init(createLayer('h50%')));
                assert.equal(property.isValid(), true);
            ...
            describe('apply', function() {
                        it('width', function() {
                            var component = src.Component.init(createLayer('w1', 1, 2, 3, 4));
                        ...
                        it('width-addition', function() {
                            var component = src.Component.init(createLayer('w+1', 1, 2, 3, 4));
                            var property = src.Property.parse(component);
                            property.apply();
                        ...
                        it('width-min', function() {
                            var component = src.Component.init(createLayer('w>10', 1, 2, 3, 4));
                            var property = src.Property.parse(component);
                            property.apply();
                        ...
                        it('height', function() {
                            var component = src.Component.init(createLayer('h1', 1, 2, 3, 4));
                            var property = src.Property.parse(component);
                            property.apply();
                        ...
                        it('height-addition', function() {
                            var component = src.Component.init(createLayer('h+1', 1, 2, 3, 4));
                            var property = src.Property.parse(component);
                            property.apply();
                        ...
                        it('height-min', function() {
                            var component = src.Component.init(createLayer('h>10', 1, 2, 3, 4));
                            var property = src.Property.parse(component);
                            property.apply();
                            assert.equal(component.frame().height(), 10);
