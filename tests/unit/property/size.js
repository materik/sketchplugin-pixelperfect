...
describe('property', function() {
    describe('size', function() {
        it('type', function() {
            ...
            var property = SizeProperty.height()
            assert.equal(property.type(), 'size');
        })

        it('width', function() {
            var property = Property.parse(Component.init(createLayer('w100')));
        ...
        it('width-subtraction', function() {
            var property = Property.parse(Component.init(createLayer('w-300')));
            assert.equal(property.isValid(), true);
            assert.equal(property.key(), 'width-addition');
        ...
        it('width-percentage', function() {
            var property = Property.parse(Component.init(createLayer('w50%')));
            assert.equal(property.isValid(), true);
        ...
        it('height', function() {
            var property = Property.parse(Component.init(createLayer('h100')));
            assert.equal(property.isValid(), true);
        ...
        it('height-subtraction', function() {
            var property = Property.parse(Component.init(createLayer('h-300')));
            assert.equal(property.isValid(), true);
            assert.equal(property.key(), 'height-addition');
            assert.equal(property.value(), -300);
        });
        ...
        it('height-percentage', function() {
            var property = Property.parse(Component.init(createLayer('h50%')));
            assert.equal(property.isValid(), true);
        ...
        describe('apply', function() {
            it('width', function() {
                var component = Component.init(createLayer('w1', 1, 2, 3, 4));
            ...
            it('width-addition', function() {
                var component = Component.init(createLayer('w+1', 1, 2, 3, 4));
                var property = Property.parse(component);
                property.apply();
            ...
            it('height', function() {
                var component = Component.init(createLayer('h1', 1, 2, 3, 4));
                var property = Property.parse(component);
                property.apply();
            ...
            it('height-addition', function() {
                var component = Component.init(createLayer('h+1', 1, 2, 3, 4));
                var property = Property.parse(component);
                property.apply();
        ...
        describe('init', function() {
            ...
            it('width', function() {
                ...
                var property = SizeProperty.width(undefined, 10)
                assert.equal(property.key(), 'width')
            ...
            it('height', function() {
                ...
                assert.equal(property.key(), 'height')
                assert.equal(property.value(), 0)
                var property = SizeProperty.height(undefined, 10)
                assert.equal(property.key(), 'height')
                assert.equal(property.value(), 10)
            })
        });
